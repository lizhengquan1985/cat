...
namespace AutoTrade
{
    public class InstrumentsUtils
    {
        ...
        {
            instruments.Add(new TradeItem { quote = "okb", symbol = "ltc", MaxBuyPrice = (decimal)58.88 });
            instruments.Add(new TradeItem { quote = "okb", symbol = "etc", MaxBuyPrice = (decimal)5.88, SmallSellPrice = (decimal)6.88, EmptySize = (decimal)0.38 });
            instruments.Add(new TradeItem { quote = "okb", symbol = "eos", MaxBuyPrice = (decimal)3.88 });
            instruments.Add(new TradeItem { quote = "okb", symbol = "xrp", MaxBuyPrice = (decimal)0.38, SmallSellPrice = (decimal)0.42, EmptySize = 15 });
            instruments.Add(new TradeItem { quote = "okb", symbol = "trx", MaxBuyPrice = (decimal)0.028, SmallSellPrice = (decimal)0.032, EmptySize = 100 });

            instruments.Add(new TradeItem { quote = "okb", symbol = "dash", MaxBuyPrice = (decimal)96.66 });
            instruments.Add(new TradeItem { quote = "okb", symbol = "neo", MaxBuyPrice = (decimal)10.8 }); // --
            ...
            instruments.Add(new TradeItem { quote = "okb", symbol = "egt", MaxBuyPrice = (decimal)0.0016, SmallSellPrice = (decimal)0.0014, EmptySize = 120 });
            ...
            instruments.Add(new TradeItem { quote = "okb", symbol = "let", MaxBuyPrice = (decimal)0.0088, SmallSellPrice = (decimal)0.0066, EmptySize = 100 });
            ...
            instruments.Add(new TradeItem { quote = "okb", symbol = "xas", MaxBuyPrice = (decimal)0.12, SmallSellPrice = (decimal)0.09, EmptySize = 1 });
            instruments.Add(new TradeItem { quote = "okb", symbol = "you", MaxBuyPrice = (decimal)0.018, SmallSellPrice = (decimal)0.016, EmptySize = 10 });
        ...
        public static void InitBtc()
        {
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "trx", MaxBuyPrice = (decimal)0.00001, SmallSellPrice = (decimal)0.000007, EmptySize = 100 });
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "aac", MaxBuyPrice = (decimal)0.0000019, SmallSellPrice = (decimal)0.0000016, EmptySize = 80 });
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "ace", MaxBuyPrice = (decimal)0.0000085, SmallSellPrice = (decimal)0.000008, EmptySize = 10 });
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "cic", MaxBuyPrice = (decimal)0.00000026, SmallSellPrice = (decimal)0.00000023, EmptySize = 400 });
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "dgd", MaxBuyPrice = (decimal)0.00829, SmallSellPrice = (decimal)0.006, EmptySize = (decimal)0.01 });
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "egt", MaxBuyPrice = (decimal)0.00000052, SmallSellPrice = (decimal)0.00000036, EmptySize = 100 });
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "kan", MaxBuyPrice = (decimal)0.0000012, SmallSellPrice = (decimal)0.0000011, EmptySize = 80 });
            instruments.Add(new TradeItem { quote = "btc", symbol = "kcash", MaxBuyPrice = (decimal)0.0000078, SmallSellPrice = (decimal)0.000008, EmptySize = 10 });
            instruments.Add(new TradeItem { quote = "btc", symbol = "knc", MaxBuyPrice = (decimal)0.0000873 });
            instruments.Add(new TradeItem { quote = "btc", symbol = "lba", MaxBuyPrice = (decimal)0.00001897, SmallSellPrice = (decimal)0.000015, EmptySize = 10 });
            instruments.Add(new TradeItem { quote = "btc", symbol = "let", MaxBuyPrice = (decimal)0.0000018, SmallSellPrice = (decimal)0.0000016, EmptySize = 100 });
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "win", MaxBuyPrice = (decimal)0.00000022, SmallSellPrice = (decimal)0.00000020, EmptySize = 300 });
            instruments.Add(new TradeItem { quote = "btc", symbol = "wtc", MaxBuyPrice = (decimal)0.000900 });
            instruments.Add(new TradeItem { quote = "btc", symbol = "xas", MaxBuyPrice = (decimal)0.000042, SmallSellPrice = (decimal)0.000035, EmptySize = 1 });
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "you", MaxBuyPrice = (decimal)0.000007, SmallSellPrice = (decimal)0.000005, EmptySize = 10 });
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "zip", MaxBuyPrice = (decimal)0.000000288 });
        ...
        public static void InitEth()
        {
            ...
            instruments.Add(new TradeItem { quote = "eth", symbol = "egt", MaxBuyPrice = (decimal)0.0000160, SmallSellPrice = (decimal)0.000014, EmptySize = 100 });
