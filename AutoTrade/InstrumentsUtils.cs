...
namespace AutoTrade
{
    public class InstrumentsUtils
    {
        ...
        public static void InitOKB()
        {
            ...
            instruments.Add(new TradeItem { quote = "okb", symbol = "egt", MaxBuyPrice = (decimal)0.00388, SmallSellPrice = (decimal)0.00266, EmptySize = 200 });
        ...
        public static void InitBtc()
        {
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "egt", MaxBuyPrice = (decimal)0.000000688, SmallSellPrice = (decimal)0.000000566, EmptySize = 300 });
        ...
        public static void InitEth()
        {
            ...
            instruments.Add(new TradeItem { quote = "eth", symbol = "mvp", MaxBuyPrice = (decimal)0.000008, SmallSellPrice = (decimal)0.000006, EmptySize = 500 });
