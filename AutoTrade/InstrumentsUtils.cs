...
namespace AutoTrade
{
    public class InstrumentsUtils
    {
        ...
        public static void InitOKB()
        {
            ...
            //instruments.Add(new TradeItem { quote = "okb", symbol = "egt", MaxBuyPrice = (decimal)0.01199, SmallSellPrice = (decimal)0.01288, EmptySize = 38 });
            ...
            //instruments.Add(new TradeItem { quote = "okb", symbol = "win", MaxBuyPrice = (decimal)0.0009, SmallSellPrice = (decimal)0.00078, EmptySize = 0 });
        ...
        public static void InitBtc()
        {
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "okb", MaxBuyPrice = (decimal)0.0005, SmallSellPrice = (decimal)0.0002, EmptySize = (decimal)3 });
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "bsv", MaxBuyPrice = (decimal)0.029, SmallSellPrice = (decimal)0.023, EmptySize = (decimal)0 });
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "egt", MaxBuyPrice = (decimal)0.000000688, SmallSellPrice = (decimal)0.000000566, EmptySize = 0 });
            ...
            instruments.Add(new TradeItem { quote = "btc", symbol = "win", MaxBuyPrice = (decimal)0.00000022, SmallSellPrice = (decimal)0.00000020, EmptySize = 0 });
        ...
        public static void InitEth()
        {
            ...
            instruments.Add(new TradeItem { quote = "eth", symbol = "okb", MaxBuyPrice = (decimal)0.00888, SmallSellPrice = (decimal)0.00488, EmptySize = (decimal)3 });
            ...
            instruments.Add(new TradeItem { quote = "eth", symbol = "egt", MaxBuyPrice = (decimal)0.0000666, SmallSellPrice = (decimal)0.000016, EmptySize = 0 });
            ...
            instruments.Add(new TradeItem { quote = "eth", symbol = "mvp", MaxBuyPrice = (decimal)0.000028, SmallSellPrice = (decimal)0.000009, EmptySize = 500 });
            ...
            instruments.Add(new TradeItem { quote = "eth", symbol = "win", MaxBuyPrice = (decimal)0.000008, SmallSellPrice = (decimal)0.000007, EmptySize = 0 });
